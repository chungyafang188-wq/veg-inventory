...
function Be(e) {
	return ze(e).map((e) => e.lab).join("＋");
}
function Ve({ title: e, rows: t, portRows: n, portTab: r, setPortTab: i, portCounts: a, refresh: o, onAfterRelease: s, openDrawer: c }) {
				...
				/* @__PURE__ */ (0, E.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, E.jsx)("p", {
							...
							children: "表格點欄位直輯：Enter 存並往下、Tab 往右；藥檢／薰蒸點徽章切換。預設依 UHA 後三碼排序；編號待補排最後、再按到港日。"
						})
					]
				}),
				ee ? /* @__PURE__ */ (0, E.jsxs)("div", {
				...
				u === "table" ? /* @__PURE__ */ (0, E.jsx)("div", {
					...
					children: ie.length ? /* @__PURE__ */ (0, E.jsx)("div", {
						...
						children: /* @__PURE__ */ (0, E.jsxs)("table", {
							className: "imp-inline-table w-full table-fixed border-collapse text-sm",
							children: [
								/* @__PURE__ */ (0, E.jsxs)("colgroup", { children: [
									/* @__PURE__ */ (0, E.jsx)("col", { className: "w-[3%]" }),
									/* @__PURE__ */ (0, E.jsx)("col", { className: "w-[6%]" }),
									/* @__PURE__ */ (0, E.jsx)("col", { className: "w-[11%]" }),
									/* @__PURE__ */ (0, E.jsx)("col", { className: "w-[6%]" }),
									/* @__PURE__ */ (0, E.jsx)("col", { className: "w-[10%]" }),
									/* @__PURE__ */ (0, E.jsx)("col", { className: "w-[9%]" }),
									/* @__PURE__ */ (0, E.jsx)("col", { className: "w-[9%]" }),
									/* @__PURE__ */ (0, E.jsx)("col", { className: "w-[9%]" }),
									/* @__PURE__ */ (0, E.jsx)("col", { className: "w-[8%]" }),
									/* @__PURE__ */ (0, E.jsx)("col", { className: "w-[8%]" }),
									/* @__PURE__ */ (0, E.jsx)("col", { className: "w-[7%]" }),
									/* @__PURE__ */ (0, E.jsx)("col", { className: "w-[8%]" }),
									/* @__PURE__ */ (0, E.jsx)("col", { className: "w-[6%]" })
								] }),
								/* @__PURE__ */ (0, E.jsx)("thead", { children: /* @__PURE__ */ (0, E.jsxs)("tr", {
									...
									children: [
										...
										/* @__PURE__ */ (0, E.jsx)("th", {
											className: "px-2 py-2 text-center text-[0.7rem] font-bold text-slate-600",
											children: "階段"
										}),
										/* @__PURE__ */ (0, E.jsx)("th", {
								...
								/* @__PURE__ */ (0, E.jsx)("tbody", { children: ie.map((e, t) => {
									let n = Me(e), r = e.released || e.stageId === "release" || e.stage === "已放行", i = y.has(n), a = ze(e), o = (r) => /* @__PURE__ */ (0, E.jsx)(Le, {
										value: e[r] || "",
										onSave: (e) => D(n, r, e),
										rowIndex: t,
										colId: r,
									...
									return /* @__PURE__ */ (0, E.jsxs)("tr", {
										...
										children: [
											...
											/* @__PURE__ */ (0, E.jsx)("td", {
												className: "px-2 py-1.5 text-center align-middle tabular-nums text-slate-700",
												children: Oe(e.arriveDay) || "—"
											}),
											/* @__PURE__ */ (0, E.jsx)("td", {
												className: "truncate px-2 py-1.5 text-left align-middle font-semibold text-slate-800",
												children: e.product || "—"
											}),
											/* @__PURE__ */ (0, E.jsx)("td", {
					...
					children: oe.length ? /* @__PURE__ */ (0, E.jsx)("ul", {
						...
						children: oe.map((e) => {
							let t = e.uha || e.key, n = y.has(t), r = ze(e);
...
var He = "inline-flex cursor-pointer items-center justify-center rounded-md border border-slate-200 bg-white px-3 py-2 text-[0.8rem] font-semibold text-slate-700 hover:bg-slate-50", Ue = "inline-flex cursor-pointer items-center justify-center rounded-md border border-emerald-600 bg-emerald-600 px-3 py-2 text-[0.8rem] font-bold text-white hover:bg-emerald-700";
function We({ title: e, refresh: t }) {
...
function Ge(e, { maxSide: t = 1280, quality: n = .72, name: r } = {}) {
...
function Ze({ sourceDataUrl: e, onConfirm: t, onCancel: n, title: r = "拖曳框選要截的範圍" }) {
...
function Qe({ title: e = "判讀", drafts: t, onParsed: n, onOpenDraft: r }) {
	let [i, a] = (0, l.useState)(""), [o, s] = (0, l.useState)(null), [c, u] = (0, l.useState)(!1), [d, h] = (0, l.useState)(!1), [g, v] = (0, l.useState)(null), y = (0, l.useRef)(null), b = (0, l.useRef)(null), ee = () => {
		...
		let n = await Ge(e, { name: t || `crop-${Date.now()}.jpg` });
		s({
			dataUrl: n.dataUrl,
			name: n.name
				...
				children: [
					...
					/* @__PURE__ */ (0, E.jsxs)("label", {
						...
						children: ["文件文字（可與截圖一起用）", /* @__PURE__ */ (0, E.jsx)("textarea", {
							...
							onPaste: (e) => {
								let t = Ye(e);
								t && (e.preventDefault(), te(t, Xe(e), { goCrop: !0 }));
							}
						})]
					}),
					/* @__PURE__ */ (0, E.jsx)("button", {
...
function nt({ row: e }) {
	let t = [];
	if (e.notifyTrailer) {
		let n = tt(e.notifyTrailerAt), r = e.notifyTrailerBy || "操作員";
		t.push(`拖車已通知${n ? ` · ${n}` : ""}${r ? ` · ${r}` : ""}`);
	}
	if (e.notifyCustomer) {
		let n = tt(e.notifyCustomerAt), r = e.notifyCustomerBy || "操作員";
...
function it({ title: e, releaseTab: t, setReleaseTab: n, counts: r, rows: i, trailers: a, unpackers: o, refresh: s, onDispatched: c, onAfterUnmark: u }) {
					...
					children: /* @__PURE__ */ (0, E.jsxs)("table", {
						...
						children: [
							...
							/* @__PURE__ */ (0, E.jsx)("tbody", { children: v.map((e) => {
								let t = e.uha || e.key, n = h.has(t), r = rt(e);
								return /* @__PURE__ */ (0, E.jsxs)("tr", {
...
function st({ title: e, lists: t, boardDay: n, setBoardDay: r, openDrawer: i }) {
	let a = t.upBoardMeta || {
		total: 0,
		missingTrailer: 0
...
var ct = "imp-chip flex-shrink-0", lt = "imp-chip imp-chip-on flex-shrink-0";
function ut({ title: e, lists: t, unpackTab: n, setUnpackTab: r, openDrawer: i }) {
...
function dt({ title: e, lists: t, sumTab: n, setSumTab: r, openDrawer: i, onExport: a }) {
	let o = t.sumCounts || {
		open: 0,
		needQty: 0,
		customer: 0,
...
function ft({ activeTab: e, lists: t, releaseTab: n, setReleaseTab: r, portTab: i, setPortTab: a, unpackTab: o, setUnpackTab: s, sumTab: c, setSumTab: l, boardDay: u, setBoardDay: d, refresh: f, openDrawer: p, setActiveTab: m, padClass: h = "p-2.5" }) {
	...
	return /* @__PURE__ */ (0, E.jsxs)("div", {
		...
		children: [
			e === "parse" ? /* @__PURE__ */ (0, E.jsx)(Qe, {
				title: g,
				drafts: t.drafts,
				onParsed: f,
				onOpenDraft: (e) => p("draft", String(e))
			}) : null,
			e === "port" || e === "checklist" ? /* @__PURE__ */ (0, E.jsx)(Ve, {
				title: b.port,
				portTab: i,
				setPortTab: a,
				portCounts: v,
...
var pt = "imp-chip flex-shrink-0", mt = "imp-chip imp-chip-on flex-shrink-0", ht = "imp-chip flex-shrink-0 font-semibold", gt = "imp-chip imp-chip-on flex-shrink-0 font-semibold";
function _t(e) {
...
function yt({ activeTab: e, setActiveTab: t, tabCounts: n, contentProps: r }) {
	...
	return /* @__PURE__ */ (0, E.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, E.jsxs)("div", {
			...
			"data-imp-swipe": "1",
			onTouchStart: (e) => {
				if (e.touches.length !== 1 || _t(e.target)) return;
				let t = e.touches[0];
				i.current = {
					on: !0,
					axis: null,
			...
			onPointerDown: (e) => {
				e.pointerType === "mouse" && e.button === 0 && (_t(e.target) || (i.current = {
					on: !0,
					axis: null,
					x0: e.clientX,
					y0: e.clientY
...
var bt = "imp-chip flex-shrink-0", xt = "imp-chip imp-chip-on flex-shrink-0", St = "imp-side flex-shrink-0", Ct = "imp-side imp-side-on flex-shrink-0";
function wt({ activeTab: e, setActiveTab: t, tabCounts: n, contentProps: r }) {
	let i = w(e), a = T(i);
	return /* @__PURE__ */ (0, E.jsxs)("div", {
		className: "imp-tw relative flex min-h-[min(78vh,40rem)] max-w-full flex-col overflow-hidden rounded-2xl border border-slate-200/80 bg-slate-50/80 font-imp text-slate-800",
...
function Tt({ initialPane: e = "parse" }) {
...
function Ot(e, t = {}) {
	if (e) {
		if (Et && Dt === e) return t.pane != null && t.forcePane && window.dispatchEvent(new CustomEvent("import-set-pane", { detail: t.pane })), Et;
		if (Et) try {
			Et.unmount();
		} catch {}
		return e.innerHTML = "", Dt = e, Et = (0, u.createRoot)(e), Et.render(/* @__PURE__ */ (0, E.jsx)(Tt, { initialPane: t.pane || "parse" })), Et;
	}
}
function kt() {
	if (Et) try {
...
if (typeof window < "u" && (window.mountImportApp = Ot, window.unmountImportApp = kt, window.page === "import" && typeof window.renderImportPage == "function")) try {
	window.renderImportPage();
} catch {}
//#endregion
export { Ot as mountImportApp, kt as unmountImportApp };
